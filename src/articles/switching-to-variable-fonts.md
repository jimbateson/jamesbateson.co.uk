...
<div class="post-note"><h3>Note</h3><p>As you'll have noticed, my site is no longer using the Inter font family. However, this guide still serves as a useful example of why and how to get started with variable fonts.</p></div>
